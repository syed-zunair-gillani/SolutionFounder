...
export default function QEH() {
  return (
    <>
      ...
      <Banner
        heading="Quality Education Holdings"
        sub_heading="QEC was founded in the year 2001 with the aim of promoting the provision of high-quality education in Saudi Arabia."
        icon="Quality-Education-Holdings.png"
      />
