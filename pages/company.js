        ...
        <>
            ...
            <section className="relative bg-center bg-no-repeat bg-cover bg-cta-banner py-14">
                <figure className="absolute top-20">
                    <Image  src="/images/f-large.png" alt="f-large.png" className="absolute top-[120px] left-0" width={250} height={230}/>
                </figure>
                <div className="flex md:flex-row flex-col items-center max-w-[1200px] mx-auto md:px-6 px-3 py-28">
                    <div className="items-center w-full space-y-6 md:w-1/2">
                        <h2 className="text-3xl font-bold leading-8 text-white md:text-4xl">Our Mission</h2>
                        <p className="text-base font-medium tracking-normal text-white">Our mission is to provide the best technology solution that will <br></br>contribute in our customer’s success and growth.</p>
                        <h2 className="text-3xl font-bold leading-8 text-white md:text-4xl">Our Vision</h2>
                        <p className="text-base font-medium tracking-normal text-white">To be the right technology enabler for world.</p>
            ...
            <section className="py-14 px-7 bg-[#eff1f4] ">
                <div className="max-w-[1200px] mx-auto">
                    ...
                    <ul id="tabs" className="space-x-0 space-y-5 md:inline-flex md:space-x-5 md:space-y-0">
                    ...
                    <div id="tab-contents">
                        <div id="first" className={`border-t border-black pt-14 ${tab === 1 ? 'block' : 'hidden'}`}>
                            <div className="grid gap-5 md:grid-cols-4">
                                ...
                                <Team name="Bassam Alshamrani​" designation="CEO & HCM specialist" icon="/images/James.jpg" />
                                <Team name="Muhammad Tahir​" designation="Chief Technology Officer" icon="/images/m-tahir.png" />
                                <Team name="Bassam Alshamrani​" designation="CEO & HCM specialist" icon="/images/Bassam-Al-Shimrani.jpg" />
                                <Team name="Bassam Alshamrani​" designation="CEO & HCM specialist" icon="/images/Waqas-Hameed.jpg" />
                                <Team name="Bassam Alshamrani​" designation="CEO & HCM specialist" icon="/images/James.jpg" />
