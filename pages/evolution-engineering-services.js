...
export default function Evolution_Engineering_Services() {
  return (
    <>
      <Header />

      <Banner
        heading="Evolution Engineering Services"
        sub_heading="Evolution Engineering Services was founded in 2006 to meet the needs for professional and specialized engineering services"
        icon="Evolution-Engineering-Services.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <Image
            src="/images/evolution-engineering-services-img.jpg"
            alt="evolution-engineering-services-img.jpg"
            width={1400}
            height={800}
          />
