...
export default function Financial_Planning() {
  return (
    <>
      <Header />
      ...
      <Banner
        ...
        sub_heading="Our software is specialized for support of financial planning and forecasting for contract, capital, and indirect projects etc."
        icon="financial-planning.png"
      />
