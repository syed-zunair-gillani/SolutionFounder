...
export default function Sales() {
  return (
    <>
      ...
      <Banner
        heading="SALES"
        sub_heading="Sales enables sales teams to sell more thanks to extra options such as using closing triggers, discounts and much more. Users can communicate quickly and easily with their customers, set custom alerts for pertinent activities, and use email to attach notes to the quote. Users also have the power to design email templates for on boarding etc."
        icon="sales-1.png"
      />
