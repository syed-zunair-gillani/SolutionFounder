...
export default function LSC() {
  return (
    <>
      <Header />

      <Banner
        heading="LSC Logistics"
        sub_heading="LSC is a closed joint stock Saudi company, having ISO & FIATA certification holding membership of GACA & WCA."
        icon="LSC-B.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <Image src="/images/LSC-C.png" alt="LSC-C.png" width={1400} height={800} />
