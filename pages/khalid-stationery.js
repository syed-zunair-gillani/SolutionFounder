...
export default function Khalid_Stationery() {
  return (
    <>
      <Header />

      <Banner
        heading="Khalid Stationery"
        sub_heading="Khalid Stationery is a trading business deals in B2B and B2C customer."
        icon="Khalid-st.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <Image src="/images/Khalid-S-C.png" alt="Khalid-S-C.png" width={1400} height={800} />
