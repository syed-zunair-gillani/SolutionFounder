...
export default function Gulf_Marine() {
  return (
    <>
      ...
      <Banner
        heading="Gulf Marine Company (GM)"
        sub_heading="Gulf Marine Company (GM) started by establishing customs clearance office of ridding in 2001, specialized in logistics services such as customs clearance and land transportation."
        icon="Gulf-Marine.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <img src="/images/gulf-marine-img.jpg" alt="gulf-marine-img.jpg" />
