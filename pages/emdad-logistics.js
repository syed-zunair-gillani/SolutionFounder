...
export default function Emdad_Logistics() {
  return (
    <>
      <Header />

      <Banner
        heading="Emdad Logistics"
        sub_heading="Emdad Transportation is a truck and trailer Rental Company they r ent their truck and trailers to other companies on their request."
        icon="emdad-banner.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <Image src="/images/emdad-container.png" alt="emdad-container.png" width={1400} height={900}/>
