          ...
          <div className="p-2">
            ...
            <div id="fieldset1">
              ...
              <div className="flex space-x-1 justify-end">
                <button className="bg-[#8DC63F] hover:bg-[#302E2E] text-xs font-bold text-white py-3 w-24 items-center">
                  Next
                </button>
              </div>
            </div>
            <div id="fieldset2">
              <div className="form-group grid mb-8">
                <label className="text-[#302E2E] text-2xl font-semibold py-5 uppercase">
                  HI USER whats your Phone Number
                </label>
                <input
                  type="tel"
                  id="phone"
              ...
              <form className="form" id="addEducation" action="#">
                <div className="form-group grid mb-8">
                  ...
                  <ul>
                    ...
                    <li>
                      Your Industry is: <span>Industry</span>
                    </li>
                    <li>
                      Your Buinsess Need is : <span>Buinsess</span>
                    </li>
                    <li>
                      How many users you need : <span>Users</span>
                    </li>
                    <li>
                      Have you worked on ERP system before? :{' '}
                      <span>erpsystem</span>
                    ...
                    <li>
                      Your Key People Can Speak English? : <span>Speak</span>
                    </li>
                    <li>
                      Do You Have an It Team? : <span>Team</span>
                    </li>
                  </ul>
                </div>
                <div className="">
