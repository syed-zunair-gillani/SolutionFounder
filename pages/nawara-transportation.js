...
export default function Nawara_Transportation() {
  return (
    <>
      <Header />

      <Banner
        heading="Nawara Transportation"
        sub_heading="Nawara is one of leading logistics company in Saudi Arabia with head office in Jeddah, provides transportation and logistics services."
        icon="Nawara-Transportation.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <img
            src="/images/Nawara-Transportation-img.jpg"
            alt="Nawara-Transportation-img.jpg"
          />
