  ...
  return (
    <>
      ...
      <Banner
        ...
        sub_heading="Last updated October 17, 2020 "
        icon="term.png"
      />

      <section className="py-14 px-3">
        <div className="grid gap-4 max-w-[1200px] p-3 mx-auto ">
          <div className="space-y-4 ">
            ...
            <h2 className="md:text-4xl text-3xl leading-8 font-bold text-[#302E2E]">
              Interpretation and Definitions
            </h2>
            <h4 className="md:text-3xl text-2xl font-bold text-[#302E2E]">
              Interpretation
            </h4>
            <p className="text-base font-medium text-[#535353]">
            ...
            <ul className="space-y-3 policy">
              <li className="text-base font-medium text-[#535353] hover:text-[#8DC63F] flex items-center space-x-2">
                <BsArrowRight />
                <span>
              ...
              <li className="text-base font-medium text-[#535353] hover:text-[#8DC63F] flex items-center space-x-2">
                ...
                <span>
                  ...
                  "Our" in this Agreement) refers to Solution Founder
                  Information Technologies Global, Al Tadaman, Al Arabi Street,
                  Al Enjaz Center.
                </span>
              </li>
              <li className="text-base font-medium text-[#535353] hover:text-[#8DC63F] flex items-center space-x-2">
              ...
              <li className="text-base font-medium text-[#535353] hover:text-[#8DC63F] flex items-center space-x-2">
                <BsArrowRight />
                <span>Country refers to: Saudi Arabia</span>
              </li>
              <li className="text-base font-medium text-[#535353] hover:text-[#8DC63F] flex items-center space-x-2">
                <BsArrowRight />
                <span>
              ...
              <li className="text-base font-medium text-[#535353] hover:text-[#8DC63F] flex items-center space-x-2">
                <BsArrowRight />
                <span>
                  Website refers to Solution Founder, accessible from
                  https://www.solutionfounder.com
                </span>
              </li>
              <li className="text-base font-medium text-[#535353] hover:text-[#8DC63F] flex items-center space-x-2">
                <BsArrowRight />
          ...
          <div className="space-y-4 ">
            ...
            <p className="text-base font-medium text-[#535353]">
              ...
              your web browser. Learn more about cookies: All About Cookies.
            </p>
            <p className="text-base font-medium text-[#535353]">
          ...
          <div className="space-y-4 ">
            <h4 className="md:text-3xl text-2xl font-bold leading-8 text-[#302E2E]">
          ...
          <div className="space-y-4 ">
            ...
            <p className="text-base font-medium text-[#535353]">
              By email: hi@solutionfounder.com
            </p>
          </div>
        </div>
      </section>
