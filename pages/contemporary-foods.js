...
export default function Contemporary_Foods() {
  return (
    <>
      <Header />

      <Banner
        heading="Contemporary Foods"
        sub_heading="Contemporary Foods, a factory first of its kind in KSA established in the second industrial city of Jeddah in 2018."
        icon="Contemporary-Foods.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <Image
            src="/images/contemporary-foods-img.jpg"
            alt="contemporary-foods-img.jpg"
            width={1400}
            height={950}
          />
