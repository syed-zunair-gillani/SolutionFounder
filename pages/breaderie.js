...
export default function Breaderie() {
  return (
    <>
      <Header />
      ...
      <Banner
        heading="Breaderie"
        sub_heading="Importing their pre-baked bread and pastries from Spain, Breaderie serves sophisticated baked goods along with their own refined spread recipes."
        icon="Breaderie.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <Image src="/images/breaderie-img.jpg" alt="breaderie-img.jpg" width={1400} height={900} />
