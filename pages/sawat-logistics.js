...
export default function Sawat_Logistics() {
  return (
    <>
      <Header />

      <Banner
        heading="Swat Logistics"
        sub_heading="Swat Logistics is one of leading logistics company in Saudi Arabia with head office in Jeddah and branch office in Dammam"
        icon="Sawat-Logistics.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <Image
            src="/images/sawat-logistics-img.jpg"
            alt="sawat-logistics-img.jpg"
            width={1400}
            height={800}
          />
