...
export default function Toyland_Business() {
  return (
    <>
      <Header />
      ...
      <Banner
        heading="Toyland"
        sub_heading="Toyland is a family-owned business, first established in 1985, inspired by the vision to be the leading toy shop."
        icon="Toy-Lan.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <Image src="/images/Toy-Lan-C.png" alt="Toy-Lan-C.png" width={1400} height={800}/>
