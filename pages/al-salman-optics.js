...
export default function Al_Salman_Optics() {
  return (
    <>
      ...
      <Banner
        heading="Al Salman Optics"
        sub_heading="Al Salman Optics is one of the leading Optial store in Saudi Arabia With many branches in Capital City Riyadh and other region of kingdom."
        icon="Al-Salman-Optics.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <img
            src="/images/al-salman-optics-img.jpg"
            alt="al-salman-optics-img.jpg"
          />
