...
export default function Hospital_Management() {
  return (
    <>
      ...
      <Banner
        heading="AUTOMATED SYSTEM ALERTS"
        sub_heading="Solution Founder’s Hospital Management System is designed to manage all Operational activities. Give full visibility of business and allow you to grow in controlled and secure manner."
        icon="hospital-management.png"
      />
