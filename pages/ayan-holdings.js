...
export default function Ayan_Holdings() {
  return (
    <>
      <Header />

      <Banner
        heading="Ayan Holdings"
        sub_heading="Ayan is a Saudi-based group of companies comprised of diversified business lines with both new and deeply-rooted brands."
        icon="Ayan-Holdings.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <img
            src="/images/ayan-holdings-img.jpg"
            alt="ayan-holdings-img.jpg"
          />
