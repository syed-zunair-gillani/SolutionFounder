...
export default function Manufacturing() {
  return (
    <>
      ...
      <Banner
        heading="MANUFACTURING MANAGEMENT SYSTEM​"
        sub_heading="Sales enables sales teams to sell more thanks to extra Solution Founder’s manufacturing module is designed to manage all Operational activities. Give full visibility of business and allow you to grow in controlled and secure manner."
        icon="manufacturing-1.png"
      />
