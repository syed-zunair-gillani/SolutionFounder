...
export default function Ioud() {
  return (
    <>
      <Header />

      <Banner
        heading="iOUD (Intelligent Oud)"
        sub_heading="iOUD (Intelligent Oud) is a famous brand in GCC and now expanding globally with wide range of products."
        icon="iOUD.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <Image src="/images/ioud-img.jpg" alt="ioud-img.jpg" width={1400} height={800}/>
