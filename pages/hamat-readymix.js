...
export default function Hamat_Readymix() {
  return (
    <>
      <Header />

      <Banner
        heading="Hamat Readymix"
        sub_heading="Hamat Readymix is Manufacturing company who manufacture different type of Readymix based on customer demand and delivery them."
        icon="Hamat-b.png"
      />
      ...
      <section className="pt-14 px-7">
        <div className=" max-w-[755px] mx-auto grid gap-7">
          ...
          <Image src="/images/HamatC.png" alt="HamatC.png" width={1400} height={800}/>
